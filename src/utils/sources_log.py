...
# change10 — verification trail: each verified figure -> raw document + location.
# The small RBA CSV is archived in raw/; the large official PDFs (AEMO ISP, CSIRO
# GenCost) are kept out of the repo to stay lean and fetched locally via
# raw/download.sh. Items that cannot be archived (AEMO exemption page redirects;
# private-deal press releases; the confidential manager deck) show the URL only,
# flagged honestly. Access date fixed at the verification run. See raw/README.md.
