...
|---|---|---|---|---|
| [AEMO — Connections Scorecard / Key Connection Information (KCI)](https://www.aemo.com.au/energy-systems/electricity/national-electricity-market-nem/connections) | `data/processed/gate_stats.csv (connection gate)` | 🟡 documented benchmark (verify) | 2026-06-24 | Share of development projects reaching a connection AGREEMENT + GPS (RTB-stage 'registration / executed connection agreement' milestone; ready-for-construction) and typical application->agreement duration -> the connection-RIGHTS gate. NOT physical commissioning/energisation of built plant. |
